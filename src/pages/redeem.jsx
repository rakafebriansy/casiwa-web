                        ...
                        <div class="-m-1.5 overflow-x-auto">
                            ...
                            <div class="border rounded-lg overflow-hidden">
                                ...
                                <tbody class="divide-y divide-gray-200 text-lg">
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap font-montserratMedium text-gray-800">
                                            Saldo anda: Rp {formatCurrency(balance,'id-ID')}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="px-6 py-4 flex justify-center gap-4 items-center whitespace-nowrap font-montserratMedium text-gray-800">
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 flex justify-center whitespace-nowrap text-sm font-montserratMedium text-gray-800">
                    ...
                    <div class="flex justify-end col-span-2">
                        <div class="overflow-x-auto w-full">
                            ...
                            <div class="border rounded-lg overflow-hidden">
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col" class="px-6 py-3 text-start text-xs font-montserratMedium text-gray-500 uppercase">No. Pembayaran</th>
                                        <th scope="col" class="px-6 py-3 text-start text-xs font-montserratMedium text-gray-500 uppercase">Tanggal</th>
                                        <th scope="col" class="px-6 py-3 text-start text-xs font-montserratMedium text-gray-500 uppercase">Nominal</th>
                                        <th scope="col" class="px-6 py-3 text-end text-xs font-montserratMedium text-gray-500 uppercase">Admin</th>
                                    </tr>
                                </thead>
                                    <tbody class="divide-y divide-gray-200">
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-montserratMedium text-gray-800">John Brown</td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-montserratMedium">
                                                <button type="button" class="inline-flex items-center gap-x-2 text-sm font-montserratSemiBold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-montserratMedium text-gray-800">Jim Green</td>
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-montserratMedium text-gray-800">Joe Black</td>
