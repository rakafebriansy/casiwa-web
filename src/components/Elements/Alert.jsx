...
const Alert = (props) => {
    ...
    return (
        <div className={`p-4 flex absolute z-50 top-32 left-1/2 -translate-x-1/2 mb-4 text-sm rounded-lg dark:bg-gray-800 text-${color}-800 bg-${color}-50 dark:text-${color}-400 lg:text-xl`} role="alert">
            ...
            <button type="button" onClick={()=>{setIsShowAlert({status:false})}} className="ms-auto -mx-1.5 -my-1.5 bg-blue-50 text-blue-500 rounded-lg focus:ring-2 focus:ring-blue-400 p-1.5 hover:bg-blue-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-700" data-dismiss-target="#alert-1" aria-label="Close">
